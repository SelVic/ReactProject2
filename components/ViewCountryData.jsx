            ...
            <div className="view-data-grid">
                <div>
                    <div className="view-data-block">
                        ...
                        <div className="view-data-value">{props.code || "Unknown"}</div>
                    </div>
                ...
                <div>
                    <div className="view-data-block">
                        ...
                        <div className="view-data-value">{props.domains || "Unknown"}</div>
                    </div>
                ...
                <div>
                    <div className="view-data-block">
                        ...
                        <div className="view-data-value">{props.population || "Unknown"}</div>
                    </div>
                ...
                <div>
                    <div className="view-data-block">
                        ...
                        <div className="view-data-value">{props.area || "Unknown"}</div>
                    </div>
                ...
                <div>
                    <div className="view-data-block">
                        ...
                        <div className="view-data-value">{props.languages || "Unknown"}</div>
                    </div>
                ...
                <div>
                    <div className="view-data-block">
                        ...
                        <div className="view-data-value-currency">{props.currencies.map(c => <span key={c.code}>{c.code} {c.name} {c.symbol}</span>) || "Unknown"}</div>
                    </div>
                ...
                <div>
                    <div className="view-data-block">
                        ...
                        <div className="view-data-value">{props.phones || "Unknown"}</div>
                    </div>
                ...
                <div>
                    <div className="view-data-block">
                        ...
                        <div className="view-data-value">{props.subregion || "Unknown"}</div>
                    </div>
